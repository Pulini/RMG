...
import com.yiyun.rmj.hx.flow.FlowTagLayout;
import com.yiyun.rmj.hx.flow.OnTagSelectListener;
import com.yiyun.rmj.utils.ToastHelper;
        ...
        public void onClick(View v) {
            if (currentDegree != null && currentDegree.getAppraiseTag() != null && !currentDegree.getAppraiseTag().isEmpty()){
                if (selectedTags == null || selectedTags.isEmpty()){
                    ToastHelper.show(getBaseContext(), "最少选择一个标签！");
                    return;
                }
            }
                ...
                public void onSuccess() {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastHelper.show(getBaseContext(), "评论成功");
                            setResult(RESULT_OK);
                            finish();
                        }
                    });
                ...
                public void onError(int code, String error) {
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            ToastHelper.show(getBaseContext(),"请求失败");
                        }
                    });
                }
