...
public class ArcProgress extends ProgressBar {
    ...
    private int colorStart = Color.parseColor("#68f2e4");
    private int colorEnd = Color.parseColor("#0ca1e5");
    private int colorCenter = Color.parseColor("#0ac3dc");
//    private int colorStart = Color.parseColor("#FF0000");
//    private int colorEnd = Color.parseColor("#EEEE00");
//    private int colorCenter = Color.parseColor("#9932CC");
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        int color = Color.parseColor("#b8b8b8");
        paint.setColor(color);
        canvas.drawText("数值越大喷雾越强", mArcRectf.centerX() - dp2px(59), mArcRectf.centerX(), paint);
        canvas.drawText("弱", dp2px(7), mArcRectf.centerX() + dp2px(20), paint);
        canvas.drawText("强", mArcRectf.right - dp2px(7), mArcRectf.centerX() + dp2px(16), paint);
        ...
        Log.e("bcz","------onDraw----mStylePogress:" + mStylePogress);

        if (mStylePogress == STYLE_ARC) {
            float targetmDegree = (360 - mDegree) * roate;
            //绘制完成部分
            int[] colors = new int[]{colorStart, colorCenter, colorEnd};
            LinearGradient linearGradient = new LinearGradient(0, 0, x, y, colors,
                    new float[]{0, 0.5f, 1.0f}, LinearGradient.TileMode.CLAMP);
