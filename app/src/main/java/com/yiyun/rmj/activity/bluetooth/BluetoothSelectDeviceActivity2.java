...
//选择设备界面
public class BluetoothSelectDeviceActivity2 extends BaseActivity2 implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch(view.getId()){
            ...
            case R.id.iv_add:
                Intent intent = new Intent(BluetoothSelectDeviceActivity2.this, BluetoothAddDeviceActivity2.class);
    ...
    protected void initView() {
        ...
        rv_list.setOnItemMenuClickListener((menuBridge, adapterPosition) -> {
            ...
            if (menuBridge.getDirection() == SwipeRecyclerView.RIGHT_DIRECTION) {
                if (menuBridge.getPosition() == 0) {
                    RoundEditDialog dialog = new RoundEditDialog(BluetoothSelectDeviceActivity2.this, "", new RoundEditDialog.IDialogBtnLiscener() {
                        @Override
                ...
                if(menuBridge.getPosition() == 1){
                    PermissionUtil.requestStoragePermission(BluetoothSelectDeviceActivity2.this, new PermissionUtil.IRequestPermissionCallBack(){
                        @Override
        ...
        rv_list.setOnItemClickListener((itemView, position) -> {
            if(BleManager.getInstance().isBlueEnable()){
                startActivity(
                        new Intent(BluetoothSelectDeviceActivity2.this, BluetoothConnecttingDeviceActivity2.class)
                                .putExtra("deviceId",listData.get(position).getId())
                );
                overridePendingTransition(R.anim.activity_rightclick_in, R.anim.activity_rightclick_out);
                finish();
...
//                        NewBleBluetoothUtil.getInstance().openBlueSync(BluetoothSelectDeviceActivity2.this,NewBleBluetoothUtil.OPEN_BLUETOOTH_REQUEST_CODE);
                    }
                }else{
                    Toast.makeText(BluetoothSelectDeviceActivity2.this,"该设备不支持蓝牙功能！",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
