...
import com.yiyun.rmj.utils.BitmapUtil;
import com.yiyun.rmj.utils.CommonUtil;
import com.yiyun.rmj.view.ClipView;
...
//        });
    ...
    private void initSrcPic() {
        ...
        try {
            bitmap = BitmapUtil.getBitmapFormUri(this, uri,720, 1280);
        } catch (IOException e) {
            Log.e("Pan","bitmap");
            e.printStackTrace();
        }
